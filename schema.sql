...
--
-- Host: localhost    Database: underwav
-- ------------------------------------------------------
...
CREATE TABLE `media` (
  ...
  `lyrics` text,
  PRIMARY KEY (`id`),
  KEY `fk_media_genre` (`genre_id`),
  KEY `media_ibfk_1` (`user_id`),
  CONSTRAINT `fk_media_genre` FOREIGN KEY (`genre_id`) REFERENCES `genre` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `media_genres` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `media_id` (`media_id`,`genre_id`),
  KEY `genre_id` (`genre_id`),
  CONSTRAINT `media_genres_ibfk_1` FOREIGN KEY (`media_id`) REFERENCES `media` (`id`) ON DELETE CASCADE,
  CONSTRAINT `media_genres_ibfk_2` FOREIGN KEY (`genre_id`) REFERENCES `genre` (`id`) ON DELETE CASCADE
...
CREATE TABLE `playlist_media` (
  ...
  `media_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `playlist_id` (`playlist_id`,`media_id`),
  KEY `media_id` (`media_id`),
  CONSTRAINT `playlist_media_ibfk_1` FOREIGN KEY (`playlist_id`) REFERENCES `playlists` (`id`) ON DELETE CASCADE,
  CONSTRAINT `playlist_media_ibfk_2` FOREIGN KEY (`media_id`) REFERENCES `media` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-04-09 18:54:05
